...
CREATE TABLE IF NOT EXISTS `id8539685_knjizara`.`racun` (
  ...
  PRIMARY KEY (`idracun`, `knjiga_idknjiga`, `korisnik_idKorisnik`),
  INDEX `fk_racun_knjiga_idx` (`knjiga_idknjiga` ASC),
  INDEX `fk_racun_korisnik1_idx` (`korisnik_idKorisnik` ASC),
  CONSTRAINT `fk_racun_knjiga`
...
START TRANSACTION;
USE `id8539685_knjizara`;
INSERT INTO `id8539685_knjizara`.`racun` (`idracun`, `ukupnaCijena`, `knjiga_idknjiga`, `korisnik_idKorisnik`) VALUES (1, 30.00, 2, 3);
INSERT INTO `id8539685_knjizara`.`racun` (`idracun`, `ukupnaCijena`, `knjiga_idknjiga`, `korisnik_idKorisnik`) VALUES (2, 45.50, 1, 2);
